...
function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="scroll-section py-16 md:py-24 px-6">
        <div className="flex justify-center">
          <div className="flex flex-col md:flex-row gap-8 md:gap-24 items-start w-full px-4 md:px-0" style={{ maxWidth: '1200px' }}>
            <div className="w-full md:flex-shrink-0 md:min-w-[280px]">
              <p className="text-sm tracking-wider" style={{ color: '#999999', fontFamily: 'Inter, sans-serif', margin: '0 0 16px 0', padding: 0 }}>
                NOTE FROM OUR CEO
              </p>
              <h2 className="font-heading text-3xl md:text-[46px] font-normal leading-tight" style={{ margin: 0, padding: 0 }}>
                The Backstory
              </h2>
            </div>
      ...
      <section className="scroll-section pt-16 md:pt-24 pb-24 md:pb-40 px-6">
        <div className="flex justify-center">
          <div className="flex flex-col md:flex-row gap-8 md:gap-24 items-start w-full px-4 md:px-0" style={{ maxWidth: '1200px' }}>
            <div className="w-full md:flex-shrink-0 md:min-w-[280px]">
              <p className="text-sm tracking-wider" style={{ color: '#999999', fontFamily: 'Inter, sans-serif', margin: '0 0 16px 0', padding: 0 }}>
