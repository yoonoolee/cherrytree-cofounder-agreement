    ...
    <div>
      ...
      <div>
        ...
        <QuestionCard
          ...
          answerPreview={getPreview(FIELDS.VESTING_SCHEDULE, formData, FIELDS.VESTING_SCHEDULE_OTHER)}
        ...
        <QuestionCard
          ...
          subQuestion={formData[FIELDS.ACCELERATION_TRIGGER] === 'Yes' ? 'For how long after the acquisition should this protection apply?' : undefined}
