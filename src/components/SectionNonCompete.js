    ...
    <div>
      ...
      <div>
        ...
        <QuestionCard
          ...
          answerPreview={getPreview(FIELDS.NON_COMPETE_DURATION, formData)}
          hint={QUESTION_CONFIG[FIELDS.NON_COMPETE_DURATION].tooltip}
        ...
        <QuestionCard
          ...
          answerPreview={getPreview(FIELDS.NON_SOLICIT_DURATION, formData)}
          hint={QUESTION_CONFIG[FIELDS.NON_SOLICIT_DURATION].tooltip}
