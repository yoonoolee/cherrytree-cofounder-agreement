      ...
      <div className="flex gap-20">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="mt-auto">
            <div className="space-y-3 mb-8">
              <div
                className="flex items-start gap-3 leading-relaxed font-light"
                style={{ color: '#6B7280' }}
              >
                <svg
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex gap-4">
            <span className="font-bold flex-shrink-0" style={{ color: '#6B7280' }}>
              1
            </span>
            <div>
              <h3 className="font-bold mb-2" style={{ color: '#6B7280' }}>
                Invite your cofounders
              </h3>
              <p className="leading-relaxed font-light" style={{ color: '#6B7280' }}>
                Click the <strong>Add Collaborators</strong> button to invite your cofounders. They
                must be collaborators to be included in the agreement.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="leading-relaxed font-light" style={{ color: '#6B7280' }}>
                Everyone can edit the survey and changes are auto-saved. Review the agreement before
                submitting so there are no surprises.
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-bold mb-2" style={{ color: '#6B7280' }}>
                You can fill out the survey asynchronously
              </h3>
              <p className="leading-relaxed font-light" style={{ color: '#6B7280' }}>
