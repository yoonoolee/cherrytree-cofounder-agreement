...
const ATTORNEYS: readonly Attorney[] = [
  {
    ...
    title: 'Practice Area',
    location: 'Location',
    description: 'Experienced attorney specializing in startup law and corporate formation.',
  },
  {
    id: 2,
    name: 'Attorney Name',
    title: 'Practice Area',
    location: 'Location',
    description: 'Focused on intellectual property and technology transactions.',
  },
  {
    id: 3,
    name: 'Attorney Name',
    title: 'Practice Area',
    location: 'Location',
    description: 'Expert in venture capital financing and founder agreements.',
  },
  {
    id: 4,
    name: 'Attorney Name',
    title: 'Practice Area',
    location: 'Location',
    description: 'Specializing in business formation and contract negotiations.',
  },
  {
    id: 5,
    name: 'Attorney Name',
    title: 'Practice Area',
    location: 'Location',
    description: 'Dedicated to helping early-stage startups navigate legal challenges.',
  },
  {
    id: 6,
    name: 'Attorney Name',
    title: 'Practice Area',
    location: 'Location',
    description: 'Provides counsel on equity structures and founder disputes.',
  },
  {
    id: 7,
    name: 'Attorney Name',
    title: 'Practice Area',
    location: 'Location',
    description: 'Experienced in corporate governance and regulatory compliance.',
  },
];
...
function AttorneyPage() {
  usePageMeta({
    ...
    description:
      'Get your cofounder agreement reviewed by experienced attorneys. Professional legal support to ensure your startup agreements are fair and enforceable.',
