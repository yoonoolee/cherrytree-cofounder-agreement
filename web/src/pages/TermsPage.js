    ...
    <div className="lp" style={{ minHeight: '100vh' }}>
      ...
      <section className="lp-legal-section">
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="lp-legal-h3">A. You'll Start by Creating an Account; Information You Must Provide</h3>
          <p className="lp-legal-p">
      ...
      <section className="lp-legal-section">
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="lp-legal-h3">A. The Security of Your Information is Important to Cherrytree</h3>
          <p className="lp-legal-p">
          ...
          <h3 className="lp-legal-h3">C. Some Third Parties May have Incidental Access to Your Information</h3>
          <p className="lp-legal-p">
      ...
      <section className="lp-legal-section">
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="lp-legal-h3">C. Your Order Cannot Contain Additional Terms or Conditions</h3>
          <p className="lp-legal-p">
          ...
          <h3 className="lp-legal-h3">H. Restrictions on Our License Grant to You For the Product</h3>
          <p className="lp-legal-p">
