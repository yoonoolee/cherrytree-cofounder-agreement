              ...
              <li key={label}>
                <button
                  ...
                  style={{
                    ...
                    color: active ? '#1a1a1a' : !action ? '#ccc' : '#666',
                    background: active ? '#e3dfd8' : 'none',
                    border: 'none',
        ...
        <div style={{ marginTop: '40px' }}>
          ...
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            {[
              {
                label: 'Newsletter',
                action: () => window.open('https://cherrytree.beehiiv.com/', '_blank'),
              },
              {
                label: 'Contact',
                action: () => window.Tally?.openPopup('2EEB99', { layout: 'modal', width: 700 }),
              },
            ].map(({ label, action }) => (
              <li key={label}>
                <button
      ...
      <main style={{ marginLeft: '210px', flex: 1, overflowY: 'auto', padding: '32px 52px 60px' }}>
        ...
        >
          <div style={{ textAlign: 'left' }}>
            ...
            <div style={{ fontSize: '12.5px', fontWeight: 200, color: '#3a3a3a' }}>
